---
title: 太虚即气 EMERGING IN THE VOID
description: An experimental painting exhibition that explores the methodology and ontology of painting within an intercultural context
cover: https://letongchen.art/cdn/images/emerging_in_the_void_title.jpg
author: Letong Chen
keywords:
  - art
  - intercultural
...
“I” cannot be expressed through language, symbols, or emotion. Instead, I am forced to manifest within qi in the form of shi, while qi is “modulated” within the traces that remain. This, too, is a phenomenological process, just as the negative space can reveal my posture. Here, “I” is neither body nor subject. I am a node and a position through which phenomena occur, existing as a sharable and inhabitable field of tension, a perceivable but non-categorizable state. (Note: the trace (image) can only reveal the state of body, but the qi can reveal the state of shi)
...
I cannot explain why the traces (images) I leave behind contain elements from the works of others. Perhaps the “I” exists in a relationally constructive state (Dasein). The appearance of limbs and faces already indicates that “I” exist outside the body; only then can the body appear as a “shadow” and “trance”. As described above, image is merely a trace left by an encounter, not the “I” itself. This de-corporealization and de-identification constitute my resistance to the highly fragmented, privatized, and alienated narratives of the contemporary world, and this resistance itself is non-narrative, non-violent, and does not sacrifice individualism. It is an ontological and phenomenological model.

![](https://letongchen.art/cdn/images/eitv_narcissuss.jpg)

![](https://letongchen.art/cdn/images/eitv_the_warrior.jpg)

Since I am not the subject within this viewing structure, and I do not possess the authority to guarantee my own emergence. The work is not a self-narration. Manifestation is an event, whether it occurs depends on whether a viewer is present. In this sense, the work also addresses social connection. Through the mechanism of emergence, it dissolves the centrality of narrative and subjectivity. Emergence is not decided by me, but by whether there is another who comes into co-presence and triggers it (again, Wang Yangming’s ‘Flowers-on-the-Cliff’ argument).

Likewise, I cannot detach myself from the external world (the traces, images, “symbols”) in order to emerge independently and self-sufficiently. Traditional Chinese art does not have a tradition of self-portraiture. Instead, literati painting employs a literary form of ‘metaphor’, allowing the subject to manifest through representations of the external world. It is not a simulation of image, but a correspondence of shi and qi. Most interestingly, like literary metaphor, the subject appears only through differences. We are mutually constituted as subjects. Thus, my self-portrait may also become viewers’ self-portrait, just as an ancient painting can become my self-portrait.
...
I do not return to traditional forms, but to the ontological conditions that preceded the formation of tradition. Not ink, but qi. Not calligraphy, but shi. Not image, but the event of emergence. What I am doing is not revivalism, but a path through which Chineseness continues into the global culture.
...
Consequently, Chinese ink art is ontologically incompatible with “contemporary art” and, furthermore, incapable of being deconstructed within its framework. “Contemporary art” thus structurally denies the legitimacy of the full existence of Chinese ink painting, which constitutes a kind of structural violence. Chinese artists are therefore compelled to dismantle “Chineseness” and reside within deviated forms and media, therefore lose the legitimacy of maintaining an intact system.

Deeming deconstructability and negatability as universal conditions for artistic legitimacy is itself a historically contingent assumption. The existence of Chinese ink art itself demonstrates that art does not necessarily generate meaning through self-negation. I, in turn, employ the non-deconstructable and non-negatable ontology of Chinese art to deconstruct and negate the ontological claim that contemporary art must be deconstructable and negatable.
...
In an era in which the self is excessively bodily and narrativized, 太虚即气 refuses to reproduce narrative and instead reduces the self to a state of existence that can be entered. It is not about who I am, but about how I emerge in the world, and how we exist together within it. What matters to me in this work as a whole is not the articulation of my Eastern identity or cultural belonging, but whether the work can continue to operate as an order of existence after identity is stripped away.

Finally, my work serves as a self-justification of painting in the age of AI. Gerhard Richter’s theory of painting as the “processing” of images can no longer fully withstand the challenge posed by AI. My self-portrait series proposes an ontological understanding of painting: painting is not the production or manipulation of images, but the temporal trace left by embodied practice on a material surface, an event of existence that cannot be outsourced to language, code, or instructions.
